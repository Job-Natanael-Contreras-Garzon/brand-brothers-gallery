...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-br from-brand-teal/5 via-purple-50/30 to-pink-50/20 dark:from-brand-dark dark:via-brand-dark-light dark:to-brand-dark overflow-hidden">
            ...
            <div className="space-y-8 animate-on-scroll translate-y-20 opacity-0 transition-all duration-700" style={{ transitionDelay: '300ms' }}>
              ...
              <div className="pt-8 animate-on-scroll translate-y-20 opacity-0 transition-all duration-700" style={{ transitionDelay: '800ms' }}>
                <button 
                  ...
                  className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-brand-teal to-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-2xl hover:shadow-brand-teal/25 hover:transform hover:scale-105"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-white/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </button>
              </div>
            </div>

            {/* Values con efectos neón mejorados */}
