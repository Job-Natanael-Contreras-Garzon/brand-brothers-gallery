      ...
      <div className="w-full px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold mb-6 animate-on-scroll translate-y-20 opacity-0 transition-all duration-700">
              {t('portfolio.title')}
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto animate-on-scroll translate-y-20 opacity-0 transition-all duration-700 mb-8" style={{ transitionDelay: '200ms' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
              <div className="text-center animate-on-scroll translate-y-20 opacity-0 transition-all duration-700" style={{ transitionDelay: '300ms' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 mb-16">
            {featuredProjects.map((project, index) => (
              <div
                key={project.id}
                className="group cursor-pointer animate-on-scroll translate-y-20 opacity-0 transition-all duration-700"
          ...
          <div className="text-center animate-on-scroll translate-y-20 opacity-0 transition-all duration-700" style={{ transitionDelay: '1300ms' }}>
            <button 
